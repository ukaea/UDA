...
int protocol_xml2(XDR* xdrs, ProtocolId protocol_id, XDRStreamDirection direction, ProtocolId* token,
...
int xdr_user_defined_type_data(XDR* xdrs, structures::LogMallocList* logmalloclist,
