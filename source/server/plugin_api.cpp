...
UDA_PLUGIN_INTERFACE* udaCreatePluginInterface(UDA_PLUGIN_INTERFACE* plugin_interface, const char* request)
{
    ...
    new_plugin_interface->userdefinedtypelist = user_defined_type_list;
    new_plugin_interface->logmalloclist = log_malloc_list;

    new_plugin_interface->interfaceVersion = 1;
    new_plugin_interface->pluginVersion = 0;
    new_plugin_interface->housekeeping = 0;
    new_plugin_interface->changePlugin = 0;
    new_plugin_interface->error_stack.nerrors = 0;
    new_plugin_interface->error_stack.idamerror = nullptr;
