...
{
    return (
        WrapXDRString(xdrs, (char*)str->archive, XMLMAXSTRING) && WrapXDRString(xdrs, (char*)str->file, XMLMAXSTRING) &&
        WrapXDRString(xdrs, (char*)str->signal, XMLMAXSTRING) && WrapXDRString(xdrs, (char*)str->owner, XMLMAXSTRING) &&
        WrapXDRString(xdrs, (char*)str->format, XMLMAXSTRING) && xdr_int(xdrs, &str->seq) &&
        xdr_int(xdrs, &str->status) && xdr_float(xdrs, &str->factor));
}
...
{
    return (WrapXDRString(xdrs, (char*)str->id, XMLMAXSTRING) && xdr_instance(xdrs, &str->instance) &&
            xdr_float(xdrs, &str->aerr) && xdr_float(xdrs, &str->rerr));
}
...
{
    return (WrapXDRString(xdrs, (char*)str->id, XMLMAXSTRING) && xdr_instance(xdrs, &str->instance) &&
            xdr_int(xdrs, &str->nco) && xdr_int(xdrs, &str->supply));
}
...
{
    return (WrapXDRString(xdrs, (char*)str->id, XMLMAXSTRING) && xdr_instance(xdrs, &str->instance) &&
            xdr_float(xdrs, &str->r) && xdr_float(xdrs, &str->z) && xdr_float(xdrs, &str->angle) &&
            xdr_float(xdrs, &str->aerr) && xdr_float(xdrs, &str->rerr));
}
...
{
    return (WrapXDRString(xdrs, (char*)str->id, XMLMAXSTRING) && xdr_instance(xdrs, &str->instance) &&
            xdr_int(xdrs, &str->nco) && xdr_float(xdrs, &str->aerr) && xdr_float(xdrs, &str->rerr));
}
...
{
    return (WrapXDRString(xdrs, (char*)str->id, XMLMAXSTRING) && xdr_instance(xdrs, &str->instance) &&
            xdr_int(xdrs, &str->nco) && xdr_int(xdrs, &str->modelnrnz[0]) && xdr_int(xdrs, &str->modelnrnz[1]) &&
            xdr_float(xdrs, &str->aerr) && xdr_float(xdrs, &str->rerr));
}
...
{
    return (WrapXDRString(xdrs, (char*)str->id, XMLMAXSTRING) && xdr_instance(xdrs, &str->instance) &&
            xdr_int(xdrs, &str->nco) && xdr_int(xdrs, &str->turns) && xdr_float(xdrs, &str->fturns) &&
            xdr_int(xdrs, &str->modelnrnz[0]) && xdr_int(xdrs, &str->modelnrnz[1]) && xdr_float(xdrs, &str->aerr) &&
...
{
    return (xdr_int(xdrs, &str->nco) && xdr_float(xdrs, &str->factor));
}
...
{
    return (WrapXDRString(xdrs, (char*)str->device, XMLMAXSTRING) && xdr_int(xdrs, &str->exp_number) &&
            xdr_int(xdrs, &str->nfluxloops) && xdr_int(xdrs, &str->nmagprobes) && xdr_int(xdrs, &str->npfcircuits) &&
            xdr_int(xdrs, &str->npfpassive) && xdr_int(xdrs, &str->npfsupplies) &&
            xdr_int(xdrs, &str->nplasmacurrent) && xdr_int(xdrs, &str->ndiamagnetic) &&
            xdr_int(xdrs, &str->ntoroidalfield) && xdr_int(xdrs, &str->npfcoils) && xdr_int(xdrs, &str->nlimiter));
}
