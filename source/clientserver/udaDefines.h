...
#define PRIVATEFLAG_XDRFILE                                                                                            \
    (unsigned int)1 // 0001        Use an intermediate file containing the XDR data rather than a data stream
...
#define CLIENTFLAG_REUSELASTHANDLE                                                                                     \
    32u // 0010 0000    Reuse the last issued handle value (for this thread) - assume application has freed heap
#define CLIENTFLAG_FREEREUSELASTHANDLE                                                                                 \
    64u // 0100 0000    Free the heap associated with the last issued handle and reuse the handle value
