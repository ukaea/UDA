...
if(JAVA_HOME AND IS_DIRECTORY "${JAVA_HOME}")
  ...
  if(DEFINED ENV{JAVA_HOME})
    ...
    # Convert path to suppress
    if (MINGW AND NOT "${_ENV_JAVA_HOME}" STREQUAL "")
      execute_process(COMMAND cygpath.exe -ms "${_ENV_JAVA_HOME}" OUTPUT_VARIABLE _ENV_JAVA_HOME)
      string(STRIP ${_ENV_JAVA_HOME} _ENV_JAVA_HOME)
    endif()
  endif()
