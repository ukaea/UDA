...
#include "setup.inc"
    ...
    REQUIRE_THROWS_WITH( client.get("TESTPLUGIN::errortest(test=3)", ""), "[clientReadin]: No Data waiting at Socket when Data Expected!\n[idamClient]:  Protocol 11 Error (Server Block #2)\n" );
#endif
}
