#if 0
#!/bin/bash
g++ test_ece.cpp -g -std=c++11 -O0 -gdwarf-3 -o test -DHOME=$HOME -I$HOME/iter/uda/source -I$HOME/iter/uda/source/wrappers \
...
//	std::cout << "\n" << std::endl;
	...
	const uda::Result& sig = client.get("imas::get(idx=0, group='ece', variable='channel/1/t_e/data', expName='WEST', type=float, rank=1, shot=" SHOT_NUM_33456 ", )", "");
