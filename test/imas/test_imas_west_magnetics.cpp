...
#  include "setup.inc"
   ...
   const uda::Result& result = client.get("WEST::read(element='magnetics/flux_loop/Shape_of', indices='', experiment='WEST', dtype=3, shot=" SHOT_NUM ", IDS_version='')", "");
...
TEST_CASE( "Test flux data field", "[IMAS][WEST][FLUX]" )
{
#ifdef FATCLIENT
#  include "setup.inc"
#endif
    ...
    const uda::Result& result = client.get("WEST::read(element='magnetics/flux_loop/#/flux/data', indices='1', experiment='WEST', dtype=7, shot=" SHOT_NUM ", IDS_version='')", "");
